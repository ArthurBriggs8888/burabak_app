...
const PrivacyPolicy = ({navigation}) => {
    const [policy, getPolicy] = useGetPrivacy();
    const style = `
    ...
    return (
        <View style={[Styles.container, GlobalStyle.padding(20, 20, 20, 20)]}>
            ...
            { policy !== '' && (<WebView style={[GlobalStyle.margin(20, 0, 0, 0)]} source={{html: `${style}${policy}`}} />) }
            { policy === '' && <ActivityIndicator size='large' style={{position: 'absolute', left: '50%', top: '50%'}} /> }
        </View>
    )
}
